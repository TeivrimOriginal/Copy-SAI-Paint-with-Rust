...
| Кисть | размер, непрозрачность, мягкость края, сглаживание, форма кисти, зеркало |
| Ластик | размер, непрозрачность, мягкость края, сглаживание, форма кисти, зеркало |
...
от центра холста, **шесть пресетов кистей** (Перо, Тушь, Акварель, Карандаш,
Воздух, Маркер), **форма отпечатка** (круг, эллипс или квадрат), **стабилизатор**
(мазок не отстаёт от курсора, но не дрожит) и **шаг между отпечатками** — он
задан в долях диаметра и не зависит от скорости мыши.
...
зеркальный мазок, эффекты слоя, метки, переименование и многоугольное выделение.
