...
pub struct Params {
    ...
    pub bold_text: bool,
    /// Вертикальный текст: буквы идут столбиком сверху вниз.
    ...
    pub sym_sides: f32,
    /// «Липкая палочка»: цвет мазка берётся из слоя под кистью.
    pub sticky: bool,
    /// Сдвиг оттенка для липкой палочки (градусы, -180…180).
    pub sticky_hue: f32,
    /// Сдвиг насыщенности для липкой палочки (-100…100).
    pub sticky_sat: f32,
    /// «Восстанавливающая кисть»: в мазок впечатывается кусок слоя.
    pub heal: bool,
    /// Сила восстанавливающей кисти 0…1.
...
pub enum ParamRow {
    ...
    Symmetry,
    /// «Липкая палочка» со сдвигом оттенка и насыщенности.
    Sticky,
    /// «Восстанавливающая кисть» с силой впечатывания.
    Heal,
    /// Форма кисти: круг, эллипс или квадрат.
    Shape,
