...
pub const PASSES: [u8; 8] = [
    UNIT_BG, UNIT_CHECKER, UNIT_CANVAS, UNIT_FLOAT, UNIT_SOLID, UNIT_THUMBS, UNIT_MASKS, UNIT_ATLAS,
];
...
void main() {
    ...
    if (u_alpha_mask > 0.5) {
        ...
        // Гамма-коррекция: без неё тонкие штрихи 11-13 px, нарисованные без
        // хинтинга, расплываются в серое пятно. Степень 0.72 возвращает буквам
        // чёткость, не делая их жирными.
